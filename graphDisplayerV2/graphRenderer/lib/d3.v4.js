...
var simulation = function(nodes) {
  ...
  return simulation = {
    ...
    find2: function(x, y) {
      var computeDistance = (xSource, ySource, xTarget, yTarget) =>
          Math.sqrt(Math.pow(xSource - xTarget, 2) + Math.pow(ySource - yTarget,2));
      
          return nodes.map( n => ({ dist: computeDistance(x,y,n.x, n.y), id: n})).sort((a,b) => a.dist - b.dist)[0].id;
    },
